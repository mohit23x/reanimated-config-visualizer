...
// code credits: https://github.com/thisXY/react-native-easing
export default {
  linear: Easing.linear,
  ease: Easing.ease,
  quad: Easing.quad,
  cubic: Easing.cubic,
  poly: Easing.poly, //if fn works web not in mob
  sin: Easing.sin,
  circle: Easing.circle,
  exp: Easing.exp,
  elastic: Easing.elastic(1),
  back: Easing.back, //if fn works in web not in mob
  bounce: Easing.bounce,
  in: Easing.in,
  out: Easing.out, // if fn works in web not in mob
  ...
  easeInElasticCustom: Easing.out(Easing.elastic(2)),

  easeOutElastic: Easing.in(Easing.elastic(2)),
  easeOutElasticCustom: Easing.in(Easing.elastic(2)),

  easeInOutElastic: Easing.inOut(Easing.out(Easing.elastic(2))),
  easeInOutElasticCustom: Easing.inOut(Easing.out(Easing.elastic(2))),
